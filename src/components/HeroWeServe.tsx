...
const heroes: Hero[] = [
  {
    number: "01",
    title: "Combat Forces",
    image: "https://astrr.co/img/army-shoes/combat-forces.webp",
    description: "Engineered for combat operations.",
  },
  {
    number: "02",
    title: "Safety Work",
    image: "https://astrr.co/img/army-shoes/safetywork.webp",
    description: "Protection for demanding environments.",
  },
  {
    number: "03",
    title: "Police",
    image: "https://astrr.co/img/army-shoes/policeshoes.webp",
    description: "Built for law enforcement professionals.",
  },
  {
    number: "04",
    title: "Officer",
    image: "https://astrr.co/img/army-shoes/officer.webp",
    description: "Professional footwear for those who lead.",
  },
  {
    number: "05",
    title: "Security Forces",
    image: "https://astrr.co/img/army-shoes/security.webp",
